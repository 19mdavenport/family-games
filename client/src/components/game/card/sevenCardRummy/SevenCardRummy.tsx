...
const SevenCardRummy = (props: PresenterProps<SevenCardRummyView, SevenCardRummyPresenter>) => {
  ...
  return (
    <>
      ...
      <EventLog style={{position: "absolute", backgroundColor: "rgba(0, 0, 0, 0.25)", height: "30%", top: "45%", width: "25%", left: "2%", overflow: "auto"}} itemStyle={{fontSize: "smaller"}} presenterGenerator={(view) => new EventLogPresenter(view)}/>
    </>
  )
}
